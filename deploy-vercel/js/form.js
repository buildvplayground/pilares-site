...
(function () {
  ...
  form.addEventListener('submit', function (e) {
    ...
    // com anexo: multipart (PHP). Sem anexo: urlencoded, que a serverless
    // function da Vercel já recebe desserializado em req.body.
    var temArquivo = !!form.querySelector('input[type="file"]');
    var dados = temArquivo ? new FormData(form)
    ...
    var cabecalhos = { 'X-Requested-With': 'fetch' };
    if (!temArquivo) cabecalhos['Content-Type'] = 'application/x-www-form-urlencoded';

    fetch(form.getAttribute('action'), { method: 'POST', body: dados, headers: cabecalhos })
